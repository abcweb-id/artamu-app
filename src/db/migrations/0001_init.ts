/**
 * Skema versi 1, salinan persis docs/database/0001_init.sql (sudah diuji di SQLite 3.45).
 * Jangan diubah setelah dirilis: perubahan skema selalu lewat migrasi baru bernomor urut.
 * Perintah PRAGMA di dalamnya dilewati runner (lihat src/db/client.ts).
 */
